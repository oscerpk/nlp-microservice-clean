...
class ImagePipelineStub(object):
...
class ImagePipelineServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ImagePipelineServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RunPipeline': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=pipeline__pb2.PipelineReply.SerializeToString,
            ),
    }
